#!/usr/bin/env python3
"""
Targeted patching search with prompt spans.
"""
...
LOG_JSONL = OUTPUT_DIR / "quality_search_v5.jsonl"
LOG_MD = OUTPUT_DIR / "quality_search_v5.md"
OUTPUT_JSON = OUTPUT_DIR / "quality_assessment_v5.json"
...
def build_configs() -> List[Config]:
    configs = [
        ...
        Config("prompt_tail_20", "resid_post", [6, 2, 3], 1.0, "prompt_tail_20", None),
        Config("prompt_tail_10", "resid_post", [6, 2, 3], 1.0, "prompt_tail_10", None),
        Config("prompt_all_steps_10", "resid_post", [6, 2, 3], 1.0, "prompt_all", 10),
        Config("prompt_tail_20_steps_10", "resid_post", [6, 2, 3], 1.0, "prompt_tail_20", 10),
        Config("prompt_tail_20_steps_5", "resid_post", [6, 2, 3], 1.0, "prompt_tail_20", 5),
    ]
    return configs
def generate_tokens(
    model,
...
def main():
    print("\n" + "=" * 70)
    print("Quality targeted search v5")
    print("=" * 70)
