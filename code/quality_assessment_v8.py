#!/usr/bin/env python3
"""
Main quality run for the v8 prompt format.
"""
...
LOG_JSONL = OUTPUT_DIR / f"quality_search_{RUN_TAG}.jsonl"
LOG_MD = OUTPUT_DIR / f"quality_search_{RUN_TAG}.md"
OUTPUT_JSON = OUTPUT_DIR / f"quality_assessment_{RUN_TAG}.json"
